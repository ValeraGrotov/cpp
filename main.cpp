...
int main() {
    ...
    while (true) {
        ...
        int lastNumber = 1; // последнее число, которое вводил пользователь
        ...
        while (true) {            
            ...
            if (lastNumber > command) { // если последнее число больше того, что юзер ввел сейчас, то числа не возрастают
